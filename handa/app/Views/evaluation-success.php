                    ...
                    <div class="card-body" style="padding: 1rem; ">
                        <div class="align-items-center justify-content-between m-b-30">
                            <div class="row">
                               ...
                               <?php if($eventx['shorthand'] != 'opening-ceremony' && $eventx['shorthand'] == 'fnriforum' && $eventx['shorthand'] != 'presscon' && $eventx['shorthand'] != 'mousigning' && $eventx['shorthand'] != 'closing-ceremony' && $eventx['shorthand'] != 'drrm-exhibits'){
                                ?>
