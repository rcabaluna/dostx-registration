                            ...
                            <div id="privacy-notice-container">
                                <div class="mt-3 col-12">
                                    ...
                                    <?php if ($eventx['is_closed'] == 0) {
                                        ...
                                        ?>
                                            <h3 class="text-center mb-3">Registration for This Event Is Now Closed</h3>

<p>We'd like to thank everyone who expressed interest in our event and attempted to register. Due to an overwhelming response and limited capacity, we have reached full registration and are unable to accept further participants.</p>

<p>Thank you for your understanding and continued support. If you have any questions or need further assistance, please feel free to contact us.</p>

<p>Stay connected with us on our social media channels to be the first to know about upcoming events and updates.</p>

<p>Thank you for your enthusiasm, and we hope to see you at one of our future events!</p>
                                        <?php
                                    }?>
                                </div>
                            </div>
