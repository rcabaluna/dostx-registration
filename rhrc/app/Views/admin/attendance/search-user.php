                    ...
                    <div class="m-t-25">
                        <table class="table table-hover table-condensed" id="participants-table">
                            ...
                            <tbody>
                                <?php if ($participants) {
                                    $count = 0;
                                    foreach ($participants as $participantsRow) { ?>
            ...
            <div class="modal-content">
                ...
                <form method="POST" id="confirm-att-by-search">
                    <div class="modal-body text-center">
                        ...
                        <div class="m-t-20">
                            <button type="submit" class="btn btn-primary" id="confirm-attendance-options-mdl">Confirm Attendance</button><br>
...
<?php if (isset($_SESSION['exists'])) {
    echo '<script>show_notification_exists("attendance");</script>';
} ?>    
<?php if (isset($_SESSION['confirmed'])) {
    echo '<script>show_notification_confirmed("attendance");</script>';
} ?>    
<?php if (isset($_SESSION['invalid'])) {
    echo '<script>show_notification_invalid("attendance");</script>';
} ?>    
<script type="text/javascript">
    ...
    let table = $('#participants-table').DataTable();
        ...
        table.on('click', 'tbody tr', function () {
            ...
            $("#event-title-options-mdl").html(data[6]);
