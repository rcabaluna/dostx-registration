                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="text-right">
                                        <a class="btn btn-success custom-class font-weight-semibold btn-sm" href="<?=base_url('w-registration')?>">
                                            <span>Walk-in</span>
                                        </a>
                                        <a class="btn btn-primary custom-class font-weight-semibold btn-sm" href="<?=base_url('registration')?>">
