                ...
                <div class="card-body">
                    ...
                    <h4>Registration Details</h4>
                        <form id="registration-event-form">
                            <input type="hidden" name="event" value="<?=$eventx['shorthand']?>">
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="inputEmail4">Following events to attend:</label>
                                    <div class="checkbox">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12 mb-0">
                                    <button type="submit" id="reg-submit-btn" class="btn btn-primary custom-class float-right mb-2">Register</button>
                                    <button type="reset" id="reset-btn" class="btn btn-primary btn-tone custom-class">Clear</button>
                                </div>
                            </div>
                        </form>
                    </div>
