...
class Certificates extends BaseController
{
    ...
    public function certParticipation()
    {
        ...
        if ($data) {
            ...
            $pdf->Image($params['savename'], $x = 248, $y = 168, $w = 20, $h = 20, $type = '', $link = '', $align = '', $resize = false, $dpi = 300, $palign = '', $border = 0, $fitbox = false, $hidden = false, $fitonpage = false, $alt = false, $altimgs = []);
